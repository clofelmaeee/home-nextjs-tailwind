...
const AppsContent = () => {
    ...
    return (
        <div className="flex flex-col w-full">
            <div className="app-software-page-header py-[30px] px-[15px] ">
            ...
            <section className="block-restaurant flex flex-col items-center py-[100px]">
                <div className="container flex flex-col items-center">
                    ...
                    <a href="/restaurant" className="flex justify-center bg-[#ff7105] text-white px-[15px] py-[13px] text-[18px] min-w-[225px]">Learn More  </a>
                </div>
            </section>

            <section className="block-golf flex flex-col items-center pb-[100px]">
                <div className="container flex flex-col items-center pt-[100px] border-t-[1px]">
                    ...
                    <a href="#" className="flex justify-center bg-[#ff7105] text-white px-[15px] py-[13px] text-[18px] min-w-[225px]">Learn More  </a>
                </div>
            </section>
        </div>
    );
